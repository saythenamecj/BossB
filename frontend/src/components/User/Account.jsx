              ...
              <div className="flex-1 overflow-hidden shadow bg-white">
                ...
                <div className="flex flex-col gap-12 m-4 sm:mx-8 sm:my-6">
                  ...
                  <div className="flex flex-col gap-4 mt-4">
                    ...
                    <h4 className="text-sm font-medium">
                      When will my BossB's account be updated with the new email
                    ...
                    <h4 className="text-sm font-medium">
                      What happens to my existing BossB's account when I update
                    ...
                    <p className="text-sm">
                      BossB's has a 'single sign-on' policy. Any changes will
