...
const Login = () => {
  ...
  return (
    <>
      <MetaData title="Login | BossB's" />

      {loading && <BackdropLoader />}
      <main className="w-full mt-12 sm:pt-20 sm:mt-0">
        {/* <!-- row --> */}
        <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg rounded sm:rounded-3xl">
          {/* <!-- sidebar column  --> */}
          <div className="loginSidebar rounded-l-3xl bg-primary-blue p-10 pr-12 hidden sm:flex flex-col gap-4 w-2/5">
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <div className="text-center py-10 px-4 sm:px-14">
              ...
              >
                New to BossB's? Create an account
              </Link>
            </div>
            {/* <!-- edit info container --> */}
          </div>
